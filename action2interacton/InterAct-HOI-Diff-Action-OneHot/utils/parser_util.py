...
def add_data_options(parser):
    ...
    group.add_argument("--dataset", default='interact', choices=['behave', 'intercap', 'neuraldome', 'chairs', 'omomo', 'imhd', 'grab', 'interact'], type=str,
...
def get_cond_mode(args):
    if args.unconstrained:
        cond_mode = 'no_cond'
    elif args.dataset in ['behave', 'intercap', 'neuraldome', 'chairs', 'omomo', 'imhd', 'grab', 'interact']:
        cond_mode = 'action'
    else:
        cond_mode = 'text'
    return cond_mode
