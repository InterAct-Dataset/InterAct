...
def get_dataset_class(name):
    if name == "humanml":
        ...
        return HumanML3D
    elif name in ['behave', 'intercap', 'neuraldome', 'chairs', 'omomo', 'imhd', 'grab', 'interact']:
...
def get_collate_fn(name, hml_mode='train', training_stage=1):
    ...
    elif name in ['behave', 'intercap', 'neuraldome', 'chairs', 'omomo', 'imhd', 'grab', 'interact'] and training_stage==3:
...
def get_dataset(conf: DatasetConfig):
    ...
    if conf.name in ['behave', 'intercap', 'neuraldome', 'chairs', 'omomo', 'imhd', 'grab', 'interact']:
